...
distinct class ByteArrayInputStream {
    ...
    *InputStream;
    ...
    # + return - The `int` value returning from the Java mapping.
    function read3(byte[] arg0, int arg1, int arg2) returns int|error {
    ...
    function readAllBytes() returns byte[]|error {
    ...
    # + arg2 - The `int` value required to map with the Java method parameter.
    # + return - The `int` value returning from the Java mapping.
    function readNBytes(byte[] arg0, int arg1, int arg2) returns int|error {
    ...
    # + arg0 - The `int` value required to map with the Java method parameter.
    # + return - The `int` value returning from the Java mapping.
    function skip(int arg0) returns int {
    ...
    # + arg0 - The `int` value required to map with the Java method parameter.
    # + return - The `IOException` value returning from the Java mapping.
    function skipNBytes(int arg0) returns IOException? {
...
function newByteArrayInputStream1(byte[] arg0) returns ByteArrayInputStream|error {
...
# + return - The new `ByteArrayInputStream` class generated.
function newByteArrayInputStream2(byte[] arg0, int arg1, int arg2) returns ByteArrayInputStream|error {
...
function ByteArrayInputStream_nullInputStream() returns InputStream {
